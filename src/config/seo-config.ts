...
export const seoConfig: Record<string, SEOMeta> = {
  ...
  // ─── Join / Onboarding ─────────────────────────────────────────────────────
  "/join": {
    title: "Join James Bugden | Free Career Resources for Taiwan Professionals",
    description:
      "Get free career guides, resume templates, and interview prep tools designed for professionals targeting roles at multinational companies in Taiwan.",
  },
  ...
  // ─── Guides Hub ────────────────────────────────────────────────────────────
  "/guides": {
    title: "Free Career Guides | Resume, Interview & Job Search | James Bugden",
    description:
      "Browse 15+ free career guides covering resumes, interviews, LinkedIn, salary negotiation, and job search strategy. Written by a senior recruiter with 13 years of hiring experience.",
    keywords: "career guides, interview guide, resume guide, job search guide",
  },

  // ─── Quiz ──────────────────────────────────────────────────────────────────
  "/quiz": {
    title: "Are You Ready for a Foreign Company? Free Career Quiz | James Bugden",
    description:
      "Take the free readiness quiz to find out if you are prepared to land a role at a top foreign company. Get a personalized action plan in 3 minutes.",
  ...
  // ─── Review ────────────────────────────────────────────────────────────────
  "/review": {
    title: "Resume Review Service | Expert Feedback | James Bugden",
    description:
      "Get your resume reviewed by a senior recruiter who has screened thousands of applications. Actionable feedback to help you land more interviews.",
  ...
  "/resume-analyzer": {
    title: "Free AI Resume Analyzer | Get Instant Feedback | James Bugden",
    description:
      "Upload your resume and get instant AI-powered feedback on formatting, content, and impact. Built by a recruiter who reviews hundreds of resumes every month.",
    keywords: "resume analyzer, AI resume review, resume checker, CV analyzer",
  },
  "/resume": {
    title: "Free Resume Builder | Create a Professional Resume | James Bugden",
    description:
      "Build a clean, recruiter-approved resume in minutes using our free resume builder. Designed by a senior recruiter to pass ATS systems and impress hiring managers.",
  ...
  "/offer-calculator": {
    title: "Job Offer Calculator | Compare Total Compensation | James Bugden",
    description:
      "Calculate and compare the true value of job offers including base salary, bonus, stock, benefits, and more. Make smarter career decisions with data.",
  ...
  "/offer-compass": {
    title: "Offer Compass | Evaluate Job Offers Beyond Salary | James Bugden",
    description:
      "Evaluate job offers on 10+ dimensions beyond salary: growth, culture, work-life balance, and more. Make decisions you will not regret.",
  ...
  "/interview-questions": {
    title: "200+ Interview Questions & Answers | Bilingual Database | James Bugden",
    description:
      "Practice with 200+ real interview questions used by top companies. Each question includes sample answers in English and Traditional Chinese.",
    keywords: "interview questions, interview answers, common interview questions, 面試問題",
  },
  "/jobs": {
    title: "Job Board | Foreign Company Roles in Taiwan | James Bugden",
    description:
  ...
  "/tracker": {
    title: "Job Application Tracker | Stay Organized | James Bugden",
    description:
  ...
  "/salary": {
    title: "Taiwan Salary Data & Insights | Foreign Companies | James Bugden",
    description:
  ...
  "/salary/explore": {
    title: "Explore Salaries by Role & Company | Taiwan | James Bugden",
    description:
  ...
  "/salary/compare": {
    title: "Compare Salaries Across Roles & Companies | Taiwan | James Bugden",
    description:
  ...
  "/salary/insights": {
    title: "Salary Insights & Trends | Taiwan Job Market | James Bugden",
    description:
      "Data-driven insights on salary trends, compensation benchmarks, and hiring patterns in Taiwan's multinational company job market.",
    keywords: "salary trends Taiwan, compensation insights, hiring trends Taiwan",
  },
  "/salary-starter-kit": {
    title: "Salary Negotiation Starter Kit | Free Templates | James Bugden",
    description:
      "Get free email templates, scripts, and a step-by-step framework for negotiating your salary. Written by a recruiter who has seen what works.",
  ...
  "/resume-guide": {
    title: "The Complete Resume Guide | How to Write a Resume That Gets Interviews | James Bugden",
    description:
      "Learn how to write a resume that actually gets you interviews. Formatting, bullet points, ATS optimization, and real examples from a recruiter who reviews thousands of resumes every year.",
    keywords: "resume guide, how to write a resume, resume tips, ATS resume, resume examples",
  },
  "/resume-quick-reference": {
    title: "Resume Quick Reference | Cheat Sheet for Resume Writing | James Bugden",
    description:
      "One-page resume cheat sheet with formatting rules, action verbs, and do's and don'ts. Print it and keep it next to you while you write.",
    keywords: "resume cheat sheet, resume quick reference, resume formatting rules",
  },
  "/interview-prep-guide": {
    title: "Interview Prep Guide | How to Prepare for Any Interview | James Bugden",
    description:
      "Step-by-step guide to preparing for job interviews at top companies. Covers research, STAR method, common questions, and what recruiters actually look for.",
    keywords: "interview prep guide, how to prepare for interview, interview tips, STAR method",
  },
  "/interview-preparation-guide": {
    title: "Interview Preparation Guide | Deep Dive Into Interview Success | James Bugden",
    description:
      "Comprehensive interview preparation covering behavioral questions, case interviews, technical rounds, and salary discussions. From a recruiter who has conducted thousands of interviews.",
    keywords: "interview preparation, behavioral interview, case interview, technical interview prep",
  },
  "/linkedin-guide": {
    title: "LinkedIn Profile Guide | Optimize Your LinkedIn for Recruiters | James Bugden",
    description:
      "How to build a LinkedIn profile that attracts recruiters from top companies. Headline formulas, summary templates, and real optimization examples.",
    keywords: "LinkedIn guide, LinkedIn profile tips, LinkedIn for job search, recruiter LinkedIn",
  },
  "/linkedin-branding-guide": {
    title: "LinkedIn Personal Branding Guide | Stand Out to Recruiters | James Bugden",
    description:
  ...
  "/pivot-method-guide": {
    title: "The Pivot Method Guide | How to Change Careers Successfully | James Bugden",
    description:
      "A practical framework for changing careers without starting over. Identify transferable skills, build a bridge, and land your next role using the Pivot method.",
    keywords: "career change, pivot career, career transition guide, how to change careers",
  },
  "/pivot-method-mini-guide": {
    title: "Pivot Method Mini Guide | Quick Career Change Framework | James Bugden",
    description:
      "A quick-start version of the Pivot Method for career changers. Identify your strengths, scan the market, and take your first step in 30 minutes.",
    keywords: "career pivot, quick career change, career transition",
  },
  "/hr-interview-guide": {
    title: "HR Interview Guide | How to Pass the HR Screening Round | James Bugden",
    description:
      "What HR is really looking for in the screening call, and how to answer salary, availability, and motivation questions without disqualifying yourself.",
    keywords: "HR interview, HR screening, phone screen tips, HR interview questions",
  },
  "/ai-job-search-guide": {
    title: "AI Job Search Guide | Use AI Tools to Find Jobs Faster | James Bugden",
    description:
      "How to use ChatGPT, Claude, and other AI tools to speed up your job search. Resume tailoring, interview prep, company research, and networking — all AI-assisted.",
    keywords: "AI job search, ChatGPT job search, AI resume, AI interview prep",
  },
  "/job-offer-guide": {
    title: "Job Offer Guide | How to Evaluate & Negotiate Offers | James Bugden",
    description:
      "A recruiter's guide to evaluating job offers, negotiating salary, and making the right decision. Includes scripts, frameworks, and real negotiation examples.",
    keywords: "job offer guide, how to negotiate offer, salary negotiation guide, offer evaluation",
  },
  "/problem-solving-guide": {
    title: "Problem Solving Guide | Structured Thinking for Interviews | James Bugden",
    description:
      "Learn structured problem-solving frameworks that impress interviewers at top companies. MECE, root cause analysis, and hypothesis-driven approaches.",
    keywords: "problem solving interview, structured thinking, case interview framework",
  },
  "/office-politics-guide": {
    title: "Office Politics Guide | Navigate Workplace Dynamics | James Bugden",
    description:
      "A practical guide to reading and navigating office politics at multinational companies. Build influence, avoid common traps, and protect your career.",
    keywords: "office politics, workplace dynamics, corporate politics, career strategy",
  },
  "/recruiter-guide": {
    title: "How Recruiters Think | An Insider Guide | James Bugden",
    description:
      "See the hiring process from the other side. How recruiters source, screen, and evaluate candidates — and what you can do to stand out at every stage.",
  ...
  "/recruiter-screen-guide": {
    ...
    description:
      "What recruiters are checking in the first phone screen and how to answer every question. Salary expectations, availability, and the hidden dealbreakers.",
    keywords: "recruiter screen, phone screen tips, first interview, recruiter call",
  },
  "/ikigai-guide": {
    title: "Ikigai Career Guide | Find Work That Gives You Purpose | James Bugden",
    description:
      "Apply the Japanese concept of Ikigai to your career. A guided framework for finding work at the intersection of passion, skill, need, and pay.",
    keywords: "ikigai career, find purpose career, ikigai guide, meaningful work",
  },
  "/career-game-guide": {
    title: "The Career Game Guide | Play Your Career Strategically | James Bugden",
    description:
      "Think of your career as a long game. This guide covers timing, leverage, reputation building, and strategic moves that compound over years.",
    keywords: "career strategy, long-term career planning, career game, strategic career moves",
  },
  "/48-laws-guide": {
    title: "48 Laws of Power for Your Career | Strategic Career Guide | James Bugden",
    description:
      "Key principles from the 48 Laws of Power applied to your career. How to build influence, protect yourself, and navigate corporate environments.",
  ...
  "/toolkit": {
    title: "Salary Negotiation Toolkit | Scripts, Templates & Calculators | James Bugden",
    description:
      "Everything you need to negotiate your salary: email scripts, counteroffer templates, a salary calculator, and step-by-step frameworks. All free.",
    keywords: "salary negotiation toolkit, negotiation scripts, salary templates",
  },
  "/toolkit/scripts": {
    title: "Salary Negotiation Scripts | Word-for-Word Templates | James Bugden",
    description:
      "Copy-paste negotiation scripts for every situation: initial offer response, counteroffer, asking for more time, and declining gracefully.",
    keywords: "negotiation scripts, salary email templates, how to counter offer email",
  },
  "/toolkit/offer-response": {
    title: "How to Respond to a Job Offer | Email Templates | James Bugden",
    description:
      "Professional email templates for responding to job offers. Accept, negotiate, ask for time, or decline — with the exact wording to use.",
    keywords: "offer response email, how to respond to job offer, offer acceptance email",
  },
  "/toolkit/counteroffer": {
    title: "Counteroffer Email Template | How to Counter a Job Offer | James Bugden",
    description:
      "A proven counteroffer email template with fill-in-the-blank sections. Plus the strategy behind when and how much to counter.",
    keywords: "counteroffer email, how to counter offer, salary counteroffer template",
  },
  "/toolkit/calculator": {
    title: "Salary Calculator | Calculate Your True Compensation | James Bugden",
    description:
  ...
  "/toolkit/pushback": {
    title: "How to Handle Salary Pushback | Scripts & Strategy | James Bugden",
    description:
  ...
  "/toolkit/raise": {
    title: "How to Ask for a Raise | Scripts & Timing | James Bugden",
    description:
      "A step-by-step guide to asking for a raise. When to ask, how to prepare your case, and the exact words to use in the conversation.",
    keywords: "how to ask for a raise, raise request, salary increase, asking for more money",
  },
  "/toolkit/log": {
    title: "Negotiation Log | Track Your Salary Discussions | James Bugden",
    description:
  ...
  // ─── Homepage ──────────────────────────────────────────────────────────────
  "/zh-tw": {
    title: "James Bugden | 外商求職教練：幫你拿到夢想公司的 Offer",
    description:
      "13年以上資深招募官，專門幫助台灣專業人士進入頂尖外商公司。免費指南、工具和一對一求職輔導。",
  ...
  // ─── Guides Hub ────────────────────────────────────────────────────────────
  "/zh-tw/guides": {
    title: "免費求職指南 | 履歷、面試、求職攻略 | James Bugden",
    description:
      "超過15份免費求職指南，涵蓋履歷撰寫、面試準備、LinkedIn 優化和薪資談判。由13年經驗的資深招募官撰寫。",
    keywords: "求職指南, 面試指南, 履歷指南, 外商求職攻略",
  },

  // ─── Quiz ──────────────────────────────────────────────────────────────────
  "/zh-tw/quiz": {
    title: "外商求職準備度測驗 | 免費測試 | James Bugden",
    description:
  ...
  "/zh-tw/resume-analyzer": {
    title: "免費 AI 履歷分析工具 | 即時獲得專業回饋 | James Bugden",
    description:
      "上傳你的履歷，立即獲得 AI 驅動的專業回饋。格式、內容和影響力一次分析完畢。由每月審查數百份履歷的招募官打造。",
  ...
  "/zh-tw/resume-simple": {
    title: "簡易履歷產生器 | 快速建立履歷 | James Bugden",
    description:
      "快速建立簡潔專業的履歷。沒有多餘的步驟，就是一份能拿到面試機會的好履歷。",
    keywords: "簡易履歷, 快速履歷產生器",
  },
  "/zh-tw/offer-calculator": {
    title: "Offer 計算機 | 比較總薪資報酬 | James Bugden",
    description:
      "計算並比較工作 Offer 的真實價值，包含底薪、獎金、股票和福利。用數據做出更聰明的職涯決定。",
    keywords: "offer 計算機, 薪資計算機, 總薪酬計算, 工作 offer 比較",
  },
  "/zh-tw/offer-compass": {
    title: "Offer 指南針 | 超越薪水來評估工作機會 | James Bugden",
    description:
      "從成長空間、公司文化、工作生活平衡等10個以上維度來評估工作 Offer。做出不會後悔的決定。",
    keywords: "工作 offer 評估, offer 決策工具, 職涯決策框架",
  },
  "/zh-tw/interview-questions": {
    title: "200+ 面試題庫 | 中英雙語面試問答 | James Bugden",
    description:
  ...
  "/zh-tw/salary": {
    title: "台灣外商薪資數據 | 薪水查詢與比較 | James Bugden",
    description:
  ...
  "/zh-tw/resume-guide": {
    title: "完整履歷指南 | 如何寫出能拿到面試的履歷 | James Bugden",
    description:
      "學習如何撰寫一份真正能幫你拿到面試機會的履歷。格式、重點描述、ATS 優化，附有資深招募官的實際範例。",
    keywords: "履歷指南, 如何寫履歷, 履歷技巧, ATS 履歷, 外商履歷",
  },
  "/zh-tw/resume-quick-reference": {
    title: "履歷速查表 | 寫履歷必備參考 | James Bugden",
    description:
      "一頁式履歷速查表，包含格式規則、動作動詞和注意事項。寫履歷時放在手邊隨時參考。",
    keywords: "履歷速查表, 履歷格式規則, 履歷參考",
  },
  "/zh-tw/interview-prep-guide": {
    title: "面試準備指南 | 如何準備任何面試 | James Bugden",
    description:
      "逐步教你如何準備頂尖公司的面試。涵蓋公司研究、STAR 方法、常見問題和招募官真正在看的重點。",
    keywords: "面試準備, 如何準備面試, 面試技巧, STAR 方法, 外商面試",
  },
  "/zh-tw/interview-preparation-guide": {
    title: "深度面試準備攻略 | 行為面試、技術面試全攻略 | James Bugden",
    description:
      "全面的面試準備指南，涵蓋行為面試、案例分析、技術輪和薪資談判。來自做過數千場面試的招募官。",
    keywords: "面試準備攻略, 行為面試, 案例面試, 技術面試",
  },
  "/zh-tw/linkedin-guide": {
    title: "LinkedIn 個人檔案指南 | 讓招募官主動找你 | James Bugden",
    description:
      "如何打造一份吸引頂尖公司招募官的 LinkedIn 個人檔案。標題公式、自我介紹模板和優化範例。",
    keywords: "LinkedIn 指南, LinkedIn 優化, LinkedIn 求職, 招募官 LinkedIn",
  },
  "/zh-tw/linkedin-branding-guide": {
    title: "LinkedIn 個人品牌指南 | 脫穎而出的策略 | James Bugden",
    description:
      "超越基本個人檔案優化。在 LinkedIn 上建立個人品牌，讓你成為外商公司的首選候選人。",
    keywords: "LinkedIn 個人品牌, LinkedIn 策略",
  },
  "/zh-tw/pivot-method-guide": {
    title: "轉職方法指南 | 如何成功轉換跑道 | James Bugden",
    description:
      "一套實用的轉職框架，不用從零開始。找出可轉移的技能，建立橋樑，順利轉進新領域。",
    keywords: "轉職, 轉換跑道, 職涯轉型指南, 如何轉職",
  },
  "/zh-tw/pivot-method-mini-guide": {
    title: "轉職方法迷你指南 | 快速轉職框架 | James Bugden",
    description:
      "精簡版轉職方法指南。30分鐘內找出你的優勢、掃描市場並踏出第一步。",
    keywords: "快速轉職, 轉職入門",
  },
  "/zh-tw/hr-interview-guide": {
    title: "HR 面試指南 | 如何通過 HR 初篩 | James Bugden",
    description:
      "HR 在初篩電話中真正看的是什麼？如何回答薪資期望、到職時間和動機等問題而不被淘汰。",
    keywords: "HR 面試, HR 初篩, 電話面試技巧, HR 面試問題",
  },
  "/zh-tw/ai-job-search-guide": {
    title: "AI 求職指南 | 用 AI 工具加速找工作 | James Bugden",
    description:
      "如何使用 ChatGPT、Claude 等 AI 工具來加速求職。履歷客製化、面試準備、公司研究和人脈經營全靠 AI 輔助。",
    keywords: "AI 求職, ChatGPT 求職, AI 履歷, AI 面試準備",
  },
  "/zh-tw/job-offer-guide": {
    title: "Offer 指南 | 如何評估和談判工作機會 | James Bugden",
    description:
      "招募官教你如何評估工作 Offer、談判薪資並做出正確決定。包含腳本、框架和真實談判案例。",
    keywords: "offer 指南, 如何談判 offer, 薪資談判指南, offer 評估",
  },
  "/zh-tw/problem-solving-guide": {
    title: "問題解決指南 | 面試中的結構化思考 | James Bugden",
    description:
      "學習在頂尖公司面試中讓面試官印象深刻的結構化問題解決框架。MECE、根因分析和假設驅動方法。",
    keywords: "問題解決面試, 結構化思考, 案例面試框架",
  },
  "/zh-tw/office-politics-guide": {
    title: "辦公室政治指南 | 外商職場生存術 | James Bugden",
    description:
      "在跨國企業中解讀和應對辦公室政治的實用指南。建立影響力、避開常見陷阱、保護你的職涯。",
    keywords: "辦公室政治, 職場人際, 外商職場, 職涯策略",
  },
  "/zh-tw/recruiter-guide": {
    title: "招募官怎麼想 | 內幕指南 | James Bugden",
    description:
      "從招募官的角度看面試流程。招募官如何搜尋、篩選和評估候選人，以及你在每個階段如何脫穎而出。",
    keywords: "招募官怎麼想, 招募官指南, 面試流程內幕",
  },
  "/zh-tw/recruiter-screen-guide": {
    title: "招募官初篩指南 | 通過第一通電話 | James Bugden",
    description:
      "招募官在第一通電話中檢查什麼，以及如何回答每個問題。薪資期望、到職時間和隱藏的淘汰標準。",
    keywords: "招募官初篩, 電話面試, 第一輪面試",
  },
  "/zh-tw/ikigai-guide": {
    title: "Ikigai 職涯指南 | 找到有意義的工作 | James Bugden",
    description:
      "將日本的 Ikigai 概念應用到你的職涯。在熱情、技能、需求和報酬的交集找到理想工作的引導框架。",
    keywords: "ikigai 職涯, 找到職涯目標, ikigai 指南, 有意義的工作",
  },
  "/zh-tw/career-game-guide": {
    title: "職涯賽局指南 | 策略性規劃你的職涯 | James Bugden",
    description:
      "把職涯當成一場長期賽局。這份指南涵蓋時機、槓桿、聲譽建立和能隨時間複利成長的策略性行動。",
  ...
  "/zh-tw/toolkit": {
    title: "薪資談判工具包 | 腳本、模板和計算機 | James Bugden",
    description:
  ...
  "/zh-tw/toolkit/scripts": {
    ...
    description:
      "適用於各種情境的複製貼上談判腳本：初始 offer 回覆、反 offer、要求更多時間和禮貌拒絕。",
  ...
  "/zh-tw/toolkit/pushback": {
    title: "薪資談判被拒怎麼辦 | 腳本與策略 | James Bugden",
    description:
      "當公司拒絕你的薪資要求時該說什麼。保持堅定又不會失去 offer 的腳本和策略。",
  ...
  "/zh-tw/toolkit/log": {
    title: "談判紀錄 | 追蹤你的薪資討論 | James Bugden",
    description:
