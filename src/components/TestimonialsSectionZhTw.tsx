...
const allTestimonials: Testimonial[] = [
  ...
  {
    name: "Youting Chen",
    hook: "建議都有客觀且具體的來源支持，而非主觀意見，整個review過程非常有邏輯且有條理。",
    full: "分析架構非常清楚。不只提供用字遣詞和描述上的建議，還針對呈現方式和格式給出詳細的指導，這些是我過去自己檢視履歷時經常忽略的細節。同時將目標職缺描述與改進建議放在一起，讓我可以立即理解每個建議背後的原因。建議都有客觀且具體的來源支持，而非主觀意見，整個review過程非常有邏輯且有條理。格式上的建議也非常有幫助，幾個長期存在的細節問題被指出來了，回饋也解釋了每個建議背後的原因和評估標準。整體而言，這份履歷review非常有架構和邏輯性，我也透過這個過程學到了更多關於履歷撰寫的概念。",
  },
];
