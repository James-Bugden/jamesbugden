          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-wrap items-center gap-8">
              ...
              >
                ...
                <span className="text-base font-semibold" style={{ color: '#FFFFFF' }}>15K followers</span>
              </a>
              ...
              >
                ...
                <span className="text-base font-semibold" style={{ color: '#FFFFFF' }}>12K followers</span>
              </a>
            </div>
          </div>
        </div>
