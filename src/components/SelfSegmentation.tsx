...
const stages = [
  ...
  },
  {
    ...
    quote: "I'm sending applications but not getting any interviews",
    resource: "7-Day Insider Email Course",
    description:
      "How recruiters at foreign companies find and evaluate candidates in Taiwan.",
