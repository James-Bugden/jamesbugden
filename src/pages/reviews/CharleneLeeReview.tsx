      ...
      <header className="bg-nav-green sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a 
              href="/reviews/charlene-lee-resume-review.pdf"
              download 
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-card rounded-xl p-6 border border-border">
              <p className="text-sm text-muted-foreground mb-2 font-semibold">Target Readiness</p>
            ...
            <div className="bg-card rounded-xl p-6 border border-border">
              <p className="text-sm text-muted-foreground mb-2 font-semibold">After Implementing Fixes</p>
              <div className="flex items-end gap-3 mb-3">
                <div className="flex-1 h-3 bg-muted rounded-full overflow-hidden">
