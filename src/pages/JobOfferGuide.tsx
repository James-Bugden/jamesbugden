import { FileText, Clock, Briefcase, AlertTriangle, CheckCircle2, XCircle, ChevronDown, Menu, ArrowRight, Shield, Target, MessageSquare } from "lucide-react";
...
const JobOfferGuide = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO schemaJson={guideSchema({ path: "/job-offer-guide", title: "Job Offer Guide | Evaluate & Negotiate", description: "A recruiter's guide to evaluating job offers, negotiating salary, and making the right decision." })} />
      ...
      <section id="resources" className="py-14 md:py-20 px-5 md:px-6 bg-executive-green scroll-mt-24">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link to="/hr-interview-guide" className="group bg-cream/5 border border-cream/10 rounded-xl p-6 text-center hover:bg-cream/10 transition-all">
