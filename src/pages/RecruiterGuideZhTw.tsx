import { FileText, Clock, Users, AlertTriangle, CheckCircle2, XCircle, ArrowRight, Target, Shield, Briefcase, ChevronDown, Menu, Search, Star, Zap, Linkedin } from "lucide-react";
...
export default function RecruiterGuideZhTw() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="如何讓招募人員搶著要你 — James Bugden" description="讓獵頭搶著推薦你的內部攻略。了解招募人員如何思考、如何建立關係、如何進入他們的視野。" path="/zh-tw/recruiter-guide" />
