import { FileText, Clock, Users, AlertTriangle, CheckCircle2, XCircle, ArrowRight, Target, Shield, Briefcase, ChevronDown, Menu, Search, Phone, Mail, Linkedin, Star, TrendingUp, UserCheck, Eye, EyeOff, Zap, MessageSquare } from "lucide-react";
...
export default function RecruiterGuide() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO
        title="How to Get Recruiters to Fight Over You — James Bugden"
        description="The insider playbook to getting headhunted. Learn how recruiters think, how to build relationships, and how to get on their radar."
