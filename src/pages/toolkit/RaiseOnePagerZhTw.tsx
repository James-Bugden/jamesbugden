          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="bg-muted rounded-xl overflow-hidden shadow-premium print:hidden">
              ...
              <div className="p-6 space-y-6">
                ...
                <div><p className="font-semibold text-foreground mb-3">我的要求</h3><ul className="text-sm space-y-1"><li className="text-foreground">• 首要：{exampleAsk.primary}</li><li className="text-foreground">• 替代方案：{exampleAsk.alternative}</li><li className="text-foreground">• 底薪凍結時的備案：{exampleAsk.fallback}</li></ul></div>
      ...
      <section className="pb-12 px-5 md:px-6 print:hidden">
        <div className="container mx-auto max-w-5xl">
          <div className="bg-gold/10 rounded-xl p-6 border-l-4 border-gold">
            <p className="font-heading text-lg text-gold mb-4">💡 提示</h3>
