...
const guides: Guide[] = [
  ...
  { id: "linkedin-guide", title: { en: "LinkedIn for Job Search", zh: "LinkedIn 求職攻略" }, description: { en: "How to optimize your LinkedIn so recruiters actually find you.", zh: "怎麼調整 LinkedIn，讓 Recruiter 主動來找你。" }, enPath: "/linkedin-guide", zhPath: "/zh-tw/linkedin-guide", tag: "getting-started", miniOf: "linkedin-brand" },
  { id: "linkedin-brand", title: { en: "LinkedIn for Job Seekers: Stop Applying, Start Getting Found", zh: "LinkedIn 求職者指南：別再海投，讓機會來找你" }, description: { en: "Build a personal brand that gets you inbound opportunities. Not just a profile update.", zh: "打造個人品牌，讓機會主動找上門。不只是改個大頭照。" }, enPath: "/linkedin-branding-guide", zhPath: "/zh-tw/linkedin-branding-guide", tag: "getting-started" },
  ...
  { id: "interview-prep", title: { en: "Interview Prep Guide", zh: "面試準備指南" }, description: { en: "How to prepare for interviews at foreign companies in Taiwan. What they actually ask and why.", zh: "在台灣準備外商面試的完整攻略。他們問什麼、為什麼這樣問。" }, enPath: "/interview-prep-guide", zhPath: "/zh-tw/interview-prep-guide", tag: "applying", miniOf: "interview-full" },
