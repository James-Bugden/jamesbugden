...
const journeyItems: JourneyItem[] = [
  ...
  { id: "interview-questions", title: { en: "Interview Question Bank", zh: "面試題庫" }, description: { en: "500+ real interview questions from top companies, sorted by category and difficulty.", zh: "500+ 道頂尖企業真實面試題，依類別與難度分類。" }, enPath: "/interview-questions", zhPath: "/zh-tw/interview-questions", tag: "interviewing", contentType: "tool" },
