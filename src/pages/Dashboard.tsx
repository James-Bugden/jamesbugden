...
const guides: Guide[] = [
  ...
  { id: "linkedin-guide", title: { en: "LinkedIn for Job Search", zh: "LinkedIn 求職攻略" }, description: { en: "How to optimize your LinkedIn so recruiters actually find you.", zh: "怎麼調整 LinkedIn，讓 Recruiter 主動來找你。" }, enPath: "/linkedin-guide", zhPath: "/zh-tw/linkedin-guide", tag: "getting-started" },
