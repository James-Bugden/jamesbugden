...
const sections: Section[] = [
  {
    ...
    links: [
      ...
      { label: "Join", en: "/join", zh: "/zh-tw/join" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Offer Compass", en: "/offer-compass", zh: "/zh-tw/offer-compass" },
      { label: "Offer Compass Compare", en: "/offer-compass/compare" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "48 Laws Guide", en: "/48-laws-guide" },
    ],
  },
  {
    title: "Toolkit",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Admin Salary Checks", en: "/admin/salary-checks" },
      { label: "Import Questions", en: "/admin/import-questions" },
