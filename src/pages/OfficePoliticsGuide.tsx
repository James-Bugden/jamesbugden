import { Clock, ChevronDown, Menu, Users, Shield, Target, Zap, AlertTriangle, Eye, Brain, ArrowRight } from "lucide-react";
...
const OfficePoliticsGuide = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO schemaJson={guideSchema({ path: "/office-politics-guide", title: "Office Politics Guide | Workplace Tips", description: "A practical guide to reading and navigating office politics at multinational companies." })} />
...
{/* Hero */}
      <section className="pt-28 md:pt-36 pb-14 md:pb-20 px-5 md:px-6 bg-executive-green">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-cream/90 mb-3">Without Backstabbing, Sucking Up, or Getting Fired</p>
        ...
        <div className="container mx-auto max-w-3xl">
          <div className="flex items-start gap-5 mb-8">
            ...
            <div className="pt-3">
              ...
              <p className="text-gold-soft/80">Keep levelling up your career</p>
            </div>
          </div>
          ...
          <div className="bg-cream/5 border border-cream/10 rounded-xl p-5 md:p-6 mb-8">
            ...
            <p className="text-cream/90 text-sm italic mb-4">Secrets to Winning at Office Politics: How to Achieve Your Goals and Increase Your Influence at Work by Marie G. McIntyre, Ph.D.</p>
