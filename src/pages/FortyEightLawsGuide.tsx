...
const tocSections = [
  ...
  { id: "find-direction", label: "Find Your Direction" },
  { id: "manage-up", label: "Manage Up" },
  { id: "reputation", label: "Build Your Reputation" },
  { id: "irreplaceable", label: "Become Irreplaceable" },
  { id: "get-what-you-want", label: "Get What You Want" },
  { id: "office-politics", label: "Survive Office Politics" },
  { id: "long-game", label: "Play the Long Game" },
